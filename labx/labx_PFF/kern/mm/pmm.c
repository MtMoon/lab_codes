...
alloc_pages(size_t n) {
    ...
    while (1)
    {
         ...
         //cprintf("lalalal2.7  page == NULL ：%d  n == : %d \n", (page == NULL), n);
         //cprintf("page %x, call swap_out in alloc_pages %d\n",page, n);
         swap_out(check_mm_struct, 1, 0);  //可以换出，但内存已满，分配失败，则用fifo强行换出一页
         //cprintf("lalalal2.8\n");
    }
